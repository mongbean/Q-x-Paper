...
The rationals are a Ring as defined by the ring axioms. For $a, b, c, d, e, f\in \bZ$, 
...
\]
By the one axiom and zero axiom of $\bZ$,
\[
(a,b)
\]
...
(a\cdot1,b\cdot1)
\]
By the one axiom of $\bZ$, 
\[(a,b)\]
 
\noindent\textbf{Distributivity: }
For $x,y,z\in \bQ$, we have $x(y+z)=xy+xz$. 
\begin{proof}
Suppose $x=(a,b),y=(c,d),z=(e,f)$. Then
\begin{align*}
x(y+z)&=(a,b)\cdot((c,d)+(e,f))=(a,b)\cdot(cf+de,df)\\
&=(a(cf+de),b(df)) \\
&=(acf+ade,bdf) 
\end{align*}
For the other side, 
\[xy=(a,b)\cdot(c,d)=(ac,bd) \qquad \text{and}\qquad xz=(a,b)\cdot(e,f)=(ae,bf)\]
...
%% todo: whats the theorem

\begin{theorem}[]
    For any $(a,b)\in\mathbb{Q}$, and $a\neq0$, there exists a $(c,d)$ where $(a,b)(c,d)=(1,1)$
\end{theorem}

Consider $(b,a)$ ,and $(b,a)\in\bQ$ since $a\neq0$. Then,
\[
(a,b)(b,a)=(ab,ba)
\]
and
