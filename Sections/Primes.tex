...
\begin{theorem}[Existence of prime factors]
    For all $a(x)\in\Qx$ where $a(x)$ isn't a unit, there exists a $p(x)$ which is prime where $p(x)|a(x)$.\\
\end{theorem}
